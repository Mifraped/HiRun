...
export class ProfileComponent implements OnInit {
  ...
  public getRates() {
    this.ratingService
      .getRates(this.profileUser.id_user)
      .subscribe((resp: ResponseRates) => {
  ...
  public getServices() {
    this.userService
      ...
      .subscribe((res: ResponseRequestedService) => {
  ...
  async getData() {
    this.ratingService
      .getAvgUserRates(this.profileUser.id_user)
    ...
    this.city = this.geolocationService.cityList.find(
      (m) =>
        m.latitude === coordObj.latitude && m.longitude === coordObj.longitude
    ).municipio;
  }
